// events from file events/mips/74K/events
    {0x0, CTR(0) | CTR(1) | CTR(2) | CTR(3), "CYCLES",
     "0-0 Cycles"},
    {0x1, CTR(0) | CTR(1) | CTR(2) | CTR(3), "INSTRUCTIONS",
     "1-0 Instructions graduated"},
    {0x2, CTR(0) | CTR(2), "PREDICTED_JR_31",
     "2-0 JR $31 (return) instructions predicted including speculative instructions"},
    {0x3, CTR(0) | CTR(2), "REDIRECT_STALLS",
    ...
    {0x1c, CTR(0) | CTR(2), "L2_CACHE_WRITEBACKS",
     "28-0 L2 Cache Writebacks"},
    {0x1d, CTR(0) | CTR(2), "L2_CACHE_MISSES",
     "29-0 L2 Cache Misses"},
    {0x1e, CTR(0) | CTR(2), "FSB_FULL_STALLS",
     "30-0 Pipe stall cycles due to FSB full"},
    {0x1f, CTR(0) | CTR(2), "LDQ_FULL_STALLS",
     "31-0 Pipe stall cycles due to LDQ full"},
    {0x20, CTR(0) | CTR(2), "WBB_FULL_STALLS",
     "32-0 Pipe stall cycles due to WBB full"},
    {0x23, CTR(0) | CTR(2), "LOAD_MISS_CONSUMER_REPLAYS",
