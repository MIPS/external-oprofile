// events from file mips/74K/events
    ...
    {0x1f, CTR(0) | CTR(2), "LDQ_FULL_STALS",
    ...
    {0x44, CTR(0) | CTR(2), "OCP_ANY_REQUESTS",
     "68-0 Any OCP request accepted"},
    {0x45, CTR(0) | CTR(2), "OCP_READ_REQUESTS",
     "69-0 OCP read request accepted"},
    {0x46, CTR(0) | CTR(2), "OCP_WRITE_REQUESTS",
     "70-0 OCP write request accepted"},
    {0x4a, CTR(0) | CTR(2), "FSB_0_25_FULL",
     "74-0 FSB < 25% full"},
    {0x4b, CTR(0) | CTR(2), "LDQ_0_25_FULL",
     "75-0 LDQ < 25% full"},
    {0x4c, CTR(0) | CTR(2), "WBB_0_25_FULL",
     "76-0 WBB < 25% full"},
    ...
    {0x41e, CTR(1) | CTR(3), "FSB_50_100_FULL",
     "30-1 FSB > 50% full"},
    {0x41f, CTR(1) | CTR(3), "LDQ_50_100_FULL",
     "31-1 LDQ > 50% full"},
    {0x420, CTR(1) | CTR(3), "WBB_50_100_FULL",
     "32-1 WBB > 50% full"},
